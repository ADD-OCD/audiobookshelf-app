...
const val CUSTOM_ACTION_JUMP_FORWARD = "app.absplus.android.customAction.jump_forward";
const val CUSTOM_ACTION_JUMP_BACKWARD = "app.absplus.android.customAction.jump_backward";
const val CUSTOM_ACTION_SKIP_FORWARD = "app.absplus.android.customAction.skip_forward";
const val CUSTOM_ACTION_SKIP_BACKWARD = "app.absplus.android.customAction.skip_backward";
const val CUSTOM_ACTION_CHANGE_SPEED = "app.absplus.android.customAction.change_speed";
